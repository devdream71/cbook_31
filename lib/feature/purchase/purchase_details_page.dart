    ...
    return Scaffold(
      ...
      body: Padding(
        ...
        child: Column(
          ...
          children: [
            // Purchase information section with dynamic currency
              ...
              builder: (context, currencyProvider, child) {
                ...
                return Column(
                  children: [
                    ...
                    customRowPurchase(
                      "Purchase Date:", 
                      formatDate(widget.purchase.pruchaseDate)
                    ),
                    customRowPurchase(
                      "Details Notes", 
                      widget.purchase.detailsNotes ?? "N/A"
                    ),
                    customRowPurchase(
                      "Discount:", 
                      " ${(widget.purchase.discount ?? 0).toString()} $currency"
                    ),
                    customRowPurchase(
                      "Total Amount:",
                      "${(widget.purchase.grossTotal ?? 0).toString()} $currency "
                    ),
                  ],
                );
              }
            ...
            // Purchase details list with dynamic currency
            Expanded(
                ...
                builder: (context, currencyProvider, child) {
                  ...
                  return ListView.builder(
                    ...
                    itemBuilder: (context, index) {
                      ...
                      String itemName = purchaseProvider.getItemName(details.itemId!);
                      String unitSymbol = purchaseProvider.getUnitSymbol(details.unitId!);
                      ...
                      return Card(
                        ...
                        child: ListTile(
                          ...
                          subtitle: Text(
                            "Quantity: ${details.qty}, Price: ${details.price} $currency",
                            style: const TextStyle(fontSize: 12),
                          ),
                          trailing: Text(
                            "Subtotal: ${details.subTotal} $currency",
