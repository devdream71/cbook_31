...
class _IncomeState extends State<Income> {
    ...
    return Scaffold(
      ...
      body: Consumer<IncomeProvider>(
        builder: (context, incomeProvider, child) {
          return Column(
            children: [
              // Fixed: Top section with date pickers and total
              Padding(
                  ...
                  children: [
                    ...
                    Row(
                      children: [
                        ...
                        Text(
                          'T. Income: ৳ ${incomeProvider.totalIncome}',
                    ...
                    // Total voucher count
                    Text(
                      'Total Voucher No: ${incomeProvider.incomeModel?.data.length ?? 0}',
  ...
  // Fixed: Separate method for income list with proper null checks
  Widget _buildIncomeList(IncomeProvider provider) {
              ...
              if (mounted) {
                ScaffoldMessenger.of(context).showSnackBar(
                  const SnackBar(
                      ...
                      content: Text('Successfully deleted the income.')),
                );
              }
            },
