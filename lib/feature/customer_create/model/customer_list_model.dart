class Customer {
  ...
  final double due; // Changed from dynamic to double for consistency
  ...
  factory Customer.fromJson(Map<String, dynamic> json) {
    // Handle due amount parsing - it comes as string from API
    double parsedDue = double.tryParse(json['due']?.toString() ?? '0') ?? 0.0;
    ...
    return Customer(
      ...
      avatar: json['avatar'],
      logo: json['logo'],
      due: parsedDue, // Now properly parsed as double
...
class Purchase {
  ...
  final int userId;
  final String transactionMethod; // Fixed spelling
  ...
  factory Purchase.fromJson(Map<String, dynamic> json) {
    return Purchase(
      ...
      // FIX: Use double.tryParse instead of .toDouble()
