...
class LoginProvider with ChangeNotifier {
  ...
  // Add registration type properties
  String? _regType;
  String? get regType => _regType;
  
  bool get isPremium => _regType?.toLowerCase() == 'premium';
  bool get isFree => _regType?.toLowerCase() == 'free';
  ...
  Future<void> checkLoginStatus() async {
    ...
    // Load registration type from preferences
    _regType = prefs.getString('reg_type');
  ...
  Future<void> loginUser(String email, String password) async {
    ...
    try {
      ...
      if (response.statusCode == 200) {
        ...
        await prefs.setString('reg_type', _loginResponse!.data.regtype ?? '');

        // Update local registration type
        _regType = _loginResponse!.data.regtype ?? '';
  ...
  // Method to refresh registration type from SharedPreferences
  Future<void> loadRegType() async {
    SharedPreferences prefs = await SharedPreferences.getInstance();
    _regType = prefs.getString('reg_type');
    notifyListeners();
  }
