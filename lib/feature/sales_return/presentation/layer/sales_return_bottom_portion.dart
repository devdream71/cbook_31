...
class BottomPortionSaleReturn extends StatelessWidget {
  ...
  final VoidCallback? onSaveSuccess; // ✅ Add callback parameter
  ...
  const BottomPortionSaleReturn({
    ...
    this.onSaveSuccess, // ✅ Add callback parameter
  });
    ...
    return SingleChildScrollView(
      child: Padding(
        ...
        child: Row(
          ...
          children: [
            const SizedBox(width: 5), // Replace hPad5 with SizedBox
            InkWell(
              onTap: () async {
                debugPrint(
                ...
                if (billNo.trim().isEmpty) {
                  ...
                  if (billNo.trim().isEmpty) {
                    ...
                    if (isSuccess.isNotEmpty) {
                      ...
                      // ✅ Call callback to reset parent widget state
                      onSaveSuccess?.call();
